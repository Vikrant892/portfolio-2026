...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto -mt-12 h-[26rem] w-full max-w-5xl rounded-[30px] border border-[#e3e0d6] bg-white p-2 md:h-[40rem] md:p-5"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-[#f1efe8]">
        {children}
      </div>
    </motion.div>
  );
